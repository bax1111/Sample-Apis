var randomSaying = [
  ...
  },
  {
    ...
    occupation: "DOOP (Executive Officer) ",
    sayings: [
      "I love it out here, Amy. I feel so manly. I have a blister, I-I spit! A-And of course, I tell no one my feelings, until I write them in my dairy.",
    ],
    id: 13,
  },
  {
...
function futaramaSayings() {
  for (var i = 0; i < randomSaying.length; i++) {
    var names = randomSaying[i].name;
    //       console.log(names.first + " " + names.last);

    var coolSayings = randomSaying[i].sayings.length;
    var pickedSaying = Math.floor(Math.random() * coolSayings);
    //       console.log(randomSaying[i].sayings[pickedSaying]);

    document.getElementById("grid").innerHTML =
      randomSaying[i].sayings[pickedSaying];
  }
}
